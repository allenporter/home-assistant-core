...
async def async_setup_entry(
    ...
    async def add_add_button(coordinator: RoborockDataUpdateCoordinator) -> None:
    ...
    def start_add_button_task(coordinator: RoborockDataUpdateCoordinator) -> None:
        config_entry.async_create_task(hass, add_add_button(coordinator))

    def async_add_a01_buttons(coordinator: RoborockDataUpdateCoordinatorA01) -> None:
        async_add_entities(
            itertools.chain(
                (

...
async def async_setup_entry(
    ...
    def async_add_vacuum_b01_q7(coordinator: RoborockB01Q7UpdateCoordinator) -> None:
        async_add_entities([RoborockQ7Vacuum(coordinator)])

    def async_add_vacuum_b01_q10(coordinator: RoborockB01Q10UpdateCoordinator) -> None:
    ...
    config_entry.async_on_unload(
        coordinators.b01_q7_dispatcher.async_dispatcher_connect(async_add_vacuum_b01_q7)
    )
    config_entry.async_on_unload(
        coordinators.b01_q10_dispatcher.async_dispatcher_connect(
            async_add_vacuum_b01_q10
        )
    )
